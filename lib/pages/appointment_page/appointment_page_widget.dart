  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<List<AppoinmetnsRecord>>(
          stream: queryAppoinmetnsRecord(
            queryBuilder: (appoinmetnsRecord) => appoinmetnsRecord.where(
              'email',
          ...
          builder: (context, snapshot) {
            ...
            List<AppoinmetnsRecord> listViewAppoinmetnsRecordList =
                snapshot.data!;
            // Return an empty Container when the item does not exist.
            if (snapshot.data!.isEmpty) {
              return Container();
            }
            final listViewAppoinmetnsRecord =
                listViewAppoinmetnsRecordList.isNotEmpty
                    ? listViewAppoinmetnsRecordList.first
                    : null;
            return ListView(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                12.0, 0.0, 0.0, 0.0),
                            child: Text(
                              'day: ${listViewAppoinmetnsRecord?.day} time: ${listViewAppoinmetnsRecord?.time}',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
