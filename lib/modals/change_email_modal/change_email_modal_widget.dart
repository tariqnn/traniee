...
class ChangeEmailModalWidget extends StatefulWidget {
  const ChangeEmailModalWidget({super.key});

  @override
  State<ChangeEmailModalWidget> createState() => _ChangeEmailModalWidgetState();
}
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'aj1x0vlz' /* I am sure I want to change my ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              if (_model.newEmailTextController
                                                          .text !=
                                                      '') {
